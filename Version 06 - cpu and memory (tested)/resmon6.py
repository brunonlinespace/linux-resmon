...
class ResMonLinux(QMainWindow):
    def __init__(self):
        ...
        # Vertical QSplitter lets you drag and adjust heights across all 4 panels
        ...
        # Add all 4 panels to vertical splitter
        self.splitter.addWidget(cpu_box)
        self.splitter.addWidget(mem_box)
        self.splitter.addWidget(disk_box)
        self.splitter.addWidget(net_box)
        self.splitter.setSizes([200, 200, 200, 200])  # Equal initial panel heights
    ...
    def update_mem_data(self):
        ...
        for proc in psutil.process_iter(['pid', 'name']):
            try:
                ...
                rss = mem_info.rss    # Physical RAM
                vms = mem_info.vms    # Virtual Memory

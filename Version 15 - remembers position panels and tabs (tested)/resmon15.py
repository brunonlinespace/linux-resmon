...
QPushButton { background-color: #333333; color: #ffffff; border: 1px solid #454545; border-radius: 3px; padding: 2px 6px; }
...
class ResMonLinux(QMainWindow):
    def __init__(self):
        ...
        # Restore user settings before starting the timers
    ...
    def create_panel_header(self, title, group_box, splitter=None):
        ...
        if splitter is not None:
            ...
            btn_up.setFixedWidth(70)  # Increased width to prevent truncation
            btn_up.clicked.connect(lambda: self.move_panel(splitter, group_box, -1))
            
            btn_down = QPushButton("▼ Down")
            btn_down.setFixedWidth(70)  # Increased width to prevent truncation
    ...
    def restore_settings(self):
        ...
        # 2. Restore Tab Order (Since tabs are movable)

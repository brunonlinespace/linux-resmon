...
class ResMonLinux(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("linux-resmon.py (v23) - Linux Resource Monitor")
        ...
        # Update button text to accurately reflect the active view mode
        self.update_toggle_button_labels()
    ...
    def update_toggle_button_labels(self):
        # Display the active view name clearly on the button
        btn_text = "View: Processes" if self.net_view_mode == "processes" else "View: Interfaces"
    ...
    def create_net_widget(self, splitter=None):
        ...
        btn_toggle = QPushButton("View: Processes")

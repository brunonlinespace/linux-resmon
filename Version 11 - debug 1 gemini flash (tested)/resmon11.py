...
class ResMonLinux(QMainWindow):
    def __init__(self):
        ...
        # Robust tracking state
        self.prev_io = {}
        self.proc_cache = {}  # Persistent psutil.Process objects for accurate CPU deltas
        ...
        # Prime CPU baseline calculation
    ...
    # --- PROCESS CACHE & CLEANUP (Prevents Memory Leaks) ---
    def get_active_processes(self):
        current_pids = set(psutil.pids())

        # Clean dead PIDs from process cache
        ...
        # Fetch/Cache process objects safely
        active_procs = []
    ...
    # --- HELPER FORMATTERS & SAFE PARSERS ---
